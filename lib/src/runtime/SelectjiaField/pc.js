...
var FormField = {
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var SelectjiaField = form.getFieldInstance('Selectjia');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = SelectjiaField.getProp('id');
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('Selectjia', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "SelectjiaField_class" },
            ' ',
