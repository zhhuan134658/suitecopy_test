...
var FormField = {
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        // const value = TestPlanField.getValue();
        var value = '1';
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('TestPlan', 'placeholder');
        var required = form.getFieldProp('TestPlan', 'required');
        ...
        var deColumns = [
            ...
            },
            {
                title: '使用部位',
                dataIndex: 'position',
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.position },
                    react_1.default.createElement("span", null, record.position))); },
            },
            {
                title: '备注',
                dataIndex: 'remarks',
        ...
        return (react_1.default.createElement("div", { className: "TestPlanField_class" },
            ' ',
