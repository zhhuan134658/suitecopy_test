...
var FormField = {
    getInitialState: function () {
        ...
        return {
            Inputvalue: form.getFieldInstance('SelectPro').getValue() || '',
            //   Inputvalue: '123',
            current_page: '',
            total2: '',
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        // const value = SelectProField.getValue();
        var value = '1';
        // const extendValue = SelectProField.getExtendValue();
        var bizAsyncData = [
            {
                key: key,
                bizAlias: 'SelectPro',
    ...
    rowClick: function (record, rowkey) {
        ...
        this.setState({ Inputvalue: record.name, isModalVisible: false }, function () {
            form.setFieldValue('SelectPro', record.name);
            form.setExtendFieldValue('SelectPro', {
                id: record.id,
            });
        });
    ...
    fieldRender: function () {
        ...
        return (react_1.default.createElement("div", { className: "SelectProField_class" },
            ' ',
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                react_1.default.createElement("div", { className: "info_label" },
