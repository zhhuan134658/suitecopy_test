...
//     const placeholder = form.getFieldProp('SelectZu', 'placeholders');
//     return (
...
var FormField = {
    getInitialState: function () {
        ...
        return {
            Inputvalue: form.getFieldInstance('SelectZu').getValue() || '',
            //   Inputvalue: '123',
            current_page: '',
            total2: '',
            allData: {
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var SelectZuField = form.getFieldInstance('SelectZu');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = SelectZuField.getProp('id');
        // const value = SelectZuField.getValue();
        var value = '1';
        // const extendValue = SelectZuField.getExtendValue();
        var bizAsyncData = [
            {
                key: key,
                bizAlias: 'SelectZu',
    ...
    fieldRender: function () {
        ...
        var field = form.getFieldInstance('SelectZu');
        var label = form.getFieldProp('SelectZu', 'label');
        var required = form.getFieldProp('SelectZu', 'required');
        var placeholder = form.getFieldProp('SelectZu', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "SelectZuField_class" },
