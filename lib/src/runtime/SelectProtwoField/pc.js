...
//     form.setFieldValue('SelectProtwo', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('SelectProtwo');
//     const label = form.getFieldProp('SelectProtwo', 'label');
//     const placeholder = form.getFieldProp('SelectProtwo', 'placeholders');
//     return (
...
var FormField = {
    getInitialState: function () {
        ...
        return {
            Inputvalue: form.getFieldInstance('SelectProtwo').getValue() || '',
            //   Inputvalue: '123',
            current_page: '',
            total2: '',
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var SelectProtwoField = form.getFieldInstance('SelectProtwo');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = SelectProtwoField.getProp('id');
        // const value = SelectProtwoField.getValue();
        var value = '1';
        // const extendValue = SelectProtwoField.getExtendValue();
        var bizAsyncData = [
            {
                key: key,
        ...
        spi
            ...
            //   res.dataList,
            //   item => item.bizAlias === 'SelectProtwo',
            // );
    ...
    rowClick: function (record, rowkey) {
        ...
        this.setState({ Inputvalue: record.name, isModalVisible: false }, function () {
            form.setFieldValue('SelectProtwo', record.name);
            form.setExtendFieldValue('SelectProtwo', {
                id: record.id,
            });
        });
    ...
    fieldRender: function () {
        ...
        var field = form.getFieldInstance('SelectProtwo');
        console.log('wwwwwww', field);
        var label = form.getFieldProp('SelectProtwo', 'label');
        var required = form.getFieldProp('SelectProtwo', 'required');
        var placeholder = form.getFieldProp('SelectProtwo', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "SelectProtwoField_class" },
            ' ',
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(antd_4.Input, { readOnly: true, value: this.state.Inputvalue, onClick: this.handleAdd, placeholder: "\u8BF7\u9009\u62E9\u9879\u76EE" })),
                react_1.default.createElement(antd_4.Modal, { title: "\u9009\u62E9\u9879\u76EE", width: 1000, visible: this.state.isModalVisible, footer: [
