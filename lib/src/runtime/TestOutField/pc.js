...
var FormField = {
    ...
    handleSave: function (row) {
        ...
        //   form.setExtendFieldValue('TestOut', {
        //     data: newData,
        //   });
        // }
    ...
    asyncSetFieldProps: function (vlauedata, typename) {
        ...
        var TestOutField = form.getFieldInstance('TestOut');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = TestOutField.getProp('id');
    ...
    fieldRender: function () {
        ...
        var required = form.getFieldProp('TestOut', 'required');
        ...
        return (react_1.default.createElement("div", { className: "TestOutField_class" },
            ' ',
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                react_1.default.createElement("div", { className: "label" },
                    ...
                    label),
                react_1.default.createElement("div", null,
                    react_1.default.createElement(antd_4.Input, { readOnly: true, value: this.state.Inputvalue, onClick: this.chhandleAdd, placeholder: "\u8BF7\u9009\u62E9\u5E93\u623F" })),
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, components: components, rowClassName: function () { return 'editable-row'; }, dataSource: dataSource, columns: columns, pagination: false }),
