...
var FormField = {
    ...
    onSearchch: function (value) {
        console.log(value);
        var newvalue = this.state.allchData;
        newvalue.name = value;
        newvalue.type = 0;
        newvalue.page = 1;
        newvalue.isHouse = '1';
    ...
    asyncSetFieldProps: function (vlauedata, typename) {
        ...
        spi
            ...
            if (typename == '1') {
                ...
                _this.setState({
                    listchData: __spreadArray([], newarr),
    ...
    rowClickch: function (record, rowkey) {
        var form = this.props.form;
        console.log(record);
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('TestCun', 'placeholder');
        var required = form.getFieldProp('TestCun', 'required');
        ...
        var deColumns = [
            ...
            },
            {
                title: '库存数量',
                dataIndex: 'ku_cun',
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.ku_cun },
                    react_1.default.createElement("span", null, record.ku_cun))); },
            },
        ];
        var etColumns = [
            {
        ...
        var onSelect = function (keys, info) {
            ...
            var treedata = { type: keys[0], number: '10', page: '1', isHouse: '2' };
            _this.setState({
                allData: treedata,
            });
        ...
        var onFinish = function (values) {
            ...
            newdate.isHouse = '2';
            _this.asyncSetFieldProps(newdate, '2');
            _this.setState({
                visibleModal: false,
            });
            //   form.resetFields();
        ...
        if (this.props.runtimeProps.viewMode) {
            ...
            var _b = value.warehouse, warehouse = _b === void 0 ? '' : _b, _c = value.warehousein, warehousein = _c === void 0 ? '' : _c, _d = value.detailedData, detailedData = _d === void 0 ? [] : _d;
            return (react_1.default.createElement("div", { className: "field-wrapper" },
                react_1.default.createElement("div", { style: { marginTop: '10px' }, className: "label" }, "\u8C03\u51FA\u4ED3\u5E93"),
                react_1.default.createElement("div", { style: { marginTop: '10px' } }, warehouse),
                react_1.default.createElement("div", { style: { marginTop: '10px' }, className: "label" }, "\u8C03\u5165\u4ED3\u5E93"),
                react_1.default.createElement("div", { style: { marginTop: '10px' } }, warehousein),
        ...
        return (react_1.default.createElement("div", { className: "TestCunField_class" },
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(antd_4.Input, { readOnly: true, value: this.state.Inputvalue, onClick: this.chhandleAdd.bind(this, 'out'), placeholder: "\u8BF7\u9009\u62E9\u5E93\u623F" })),
                react_1.default.createElement("div", { className: "label", style: { marginTop: 10 } }, "\u8C03\u5165\u4ED3\u5E93"),
                react_1.default.createElement("div", null,
                    react_1.default.createElement(antd_4.Input, { readOnly: true, value: this.state.Inputvaluein, onClick: this.chhandleAdd.bind(this, 'in'), placeholder: "\u8BF7\u9009\u62E9\u5E93\u623F" })),
                react_1.default.createElement(antd_4.Modal, { title: "\u9009\u62E9\u5E93\u623F", width: 1000, visible: this.state.ischModalVisible, footer: [
                        react_1.default.createElement(antd_4.Button, { key: "back", onClick: this.handleCancelch }, "\u8FD4\u56DE"),
                        react_1.default.createElement(antd_4.Button, { key: "submit", type: "primary", loading: this.state.loading, onClick: this.handleOkch }, "\u786E\u5B9A"),
                    ], onCancel: this.handleCancelch },
                    react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearchch }),
                    react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, onRow: function (record) {
                            return {
                                onClick: _this.rowClickch.bind(_this, record),
                            };
                        }, rowKey: function (record) { return record.id; }, columns: mychcolumns, dataSource: this.state.listchData, loading: this.state.loading, pagination: false }),
                    react_1.default.createElement(antd_1.Pagination, { defaultCurrent: 1, total: this.state.totalch2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })),
                react_1.default.createElement("div", { style: { marginTop: 10 }, className: "label" }, "\u51FA\u5E93\u660E\u7EC6"),
                react_1.default.createElement("div", null,
