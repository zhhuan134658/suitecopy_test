...
var FormField = {
    ...
    habdlClick: function (item) {
        ...
        this.setState({ inputvalue: item.accountname, showElem: 'none' }, function () {
    ...
    fieldRender: function () {
        ...
        var sidebar = (react_1.default.createElement("div", null,
            ...
            react_1.default.createElement(antd_mobile_1.List, null, this.state.listData.map(function (item, index) {
                return (react_1.default.createElement(antd_mobile_1.List.Item, { onClick: _this.habdlClick.bind(_this, item), key: index, multipleLine: true }, item.accountname));
            }))));
        //详情
