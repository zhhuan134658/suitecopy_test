...
var mycolumns = [
    {
        ...
        render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.accountname },
            react_1.default.createElement("span", null, record.accountname))); },
    },
    {
        title: '账号',
        dataIndex: 'accountnumber',
        render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.accountnumber },
            react_1.default.createElement("span", null, record.accountnumber))); },
    },
    {
        title: '开户行',
        dataIndex: 'bankofdeposit',
        render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.bankofdeposit },
            react_1.default.createElement("span", null, record.bankofdeposit))); },
    },
];
...
var FormField = {
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var SelectAccField = form.getFieldInstance('SelectAcc');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = SelectAccField.getProp('id');
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('SelectAcc', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "SelectAccField_class" },
            ' ',
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(antd_4.Input, { readOnly: true, value: this.state.Inputvalue, onClick: this.handleAdd, placeholder: "\u8BF7\u9009\u62E9\u8D26\u6237" })),
                react_1.default.createElement(antd_4.Modal, { title: "\u9009\u62E9\u8D26\u6237", width: 1000, visible: this.state.isModalVisible, footer: [
