...
var FormField = {
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('TestOli', 'placeholder');
        var required = form.getFieldProp('TestOli', 'required');
        ...
        var deColumns = [
            ...
            },
            {
                ...
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.oil_consump },
                    react_1.default.createElement("span", null, record.oil_consump))); },
            },
            {
                title: '油价(元)',
                dataIndex: 'price',
        ...
        return (react_1.default.createElement("div", { className: "TestOliField_class" },
            ' ',
                ...
                react_1.default.createElement(antd_4.Modal, { className: "newModal_class", onCancel: this.handlenewCancel, visible: this.state.visibleModal, width: 1000, title: "\u65B0\u589E" },
                    react_1.default.createElement(antd_4.Form, { initialValues: { remember: true }, layout: "vertical", onFinish: onFinish, onFinishFailed: onFinishFailed },
                        ...
                        react_1.default.createElement(antd_4.Form.Item, { label: "\u7269\u54C1\u7C7B\u578B", name: "type", rules: [{ required: true, message: '请填写单位名称' }] },
                            react_1.default.createElement(antd_4.TreeSelect, { showSearch: true, style: { width: '100%' }, value: this.state.value, dropdownStyle: { maxHeight: 400, overflow: 'auto' }, treeData: this.state.treeData, placeholder: "\u8BF7\u9009\u62E9", treeDefaultExpandAll: true, onChange: onChangetree })),
