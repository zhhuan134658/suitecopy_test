...
//     const placeholder = form.getFieldProp('TestMachinery', 'placeholders');
//     return (
...
var EditableCell = function (_a) {
    ...
    if (editable) {
        childNode = editing ? (react_1.default.createElement(antd_4.Form.Item, { style: { margin: 0 }, name: dataIndex },
            react_1.default.createElement(antd_4.Input, { className: "editable-cell-value-inputNumber", ref: inputRef, onPressEnter: save, onBlur: save, min: 0, step: "0.01", placeholder: "\u8BF7\u8F93\u5165" }))) : (react_1.default.createElement("div", { className: "editable-cell-value-wrap", style: { paddingRight: 24 }, onClick: toggleEdit }, children));
        // childNode = (
        //   <Form.Item
        //     style={{ margin: 0 }}
        //     name={dataIndex}
...
var FormField = {
    ...
    handleSave: function (row) {
        ...
        //   form.setFieldValue('TestMachinery', newData);
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        spi
            ...
            //   res.dataList,
            //   item => item.bizAlias === 'TestMachinery',
            // );
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('TestMachinery', 'placeholder');
        ...
        var deColumns = [
            ...
            },
            {
                ...
                dataIndex: 'riqi',
                width: 200,
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.riqi },
                    react_1.default.createElement("span", null, record.riqi))); },
            },
            {
                title: '施工内容',
                dataIndex: 'content',
            ...
            },
            {
                ...
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.work_hours },
                    react_1.default.createElement("span", null, record.work_hours))); },
            },
            {
                title: '单价',
                dataIndex: 'price',
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.price },
                    react_1.default.createElement("span", null, record.price))); },
            },
            {
                title: '小计',
                dataIndex: 'subtotal',
        ...
        var etColumns = [
            ...
            },
            {
                ...
                render: function (text, record, index) {
                    return (react_1.default.createElement(antd_4.DatePicker, { format: "YYYY-MM-DD", placeholder: "\u8BF7\u9009\u62E9\u65E5\u671F", onChange: _this.timeChange.bind(_this, record, index, 'riqi') }));
                },
            },
            {
                title: '施工内容',
        ...
        return (react_1.default.createElement("div", { className: "TestMachineryField_class" },
            ' ',
                ...
                react_1.default.createElement(antd_4.Modal, { className: "newModal_class", onCancel: this.handlenewCancel, visible: this.state.visibleModal, width: 1000, title: "\u65B0\u589E" },
                    react_1.default.createElement(antd_4.Form, { initialValues: { remember: true }, layout: "vertical", onFinish: onFinish, onFinishFailed: onFinishFailed },
                        ...
                        react_1.default.createElement(antd_4.Form.Item, { label: "\u7269\u54C1\u7C7B\u578B", name: "type", rules: [{ required: true, message: '请填写单位名称' }] },
                            react_1.default.createElement(antd_4.TreeSelect, { style: { width: '100%' }, value: this.state.value, dropdownStyle: { maxHeight: 400, overflow: 'auto' }, treeData: this.state.treeData, placeholder: "\u8BF7\u8F93\u5165", treeDefaultExpandAll: true, onChange: onChangetree })),
