...
//     form.setFieldValue('SelecTicke', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('SelecTicke');
//     const label = form.getFieldProp('SelecTicke', 'label');
//     const placeholder = form.getFieldProp('SelecTicke', 'placeholders');
//     return (
...
var FormField = {
    ...
    handleSave: function (row) {
        ...
        //   form.setFieldValue('SelecTicke', newData);
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var SelecTickeField = form.getFieldInstance('SelecTicke');
        var Pro_name = form.getFieldValue('Autopro');
        vlauedata.project_name = Pro_name;
        var key = SelecTickeField.getProp('id');
        var value = '1';
        var bizAsyncData = [
            {
                key: key,
    ...
    rowClick: function (record, rowkey) {
        ...
        this.setState({ dataSource: newData, isModalVisible: false }, function () {
            form.setFieldValue('SelecTicke', record);
            form.setExtendFieldValue('SelecTicke', {
                record: record,
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('SelecTicke', 'placeholder');
        ...
        if (this.props.runtimeProps.viewMode) {
            ...
            var _b = value.detailname, detailname = _b === void 0 ? '' : _b;
        ...
        return (react_1.default.createElement("div", { className: "SelecTickeField_class" },
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement(antd_4.Modal, { title: "\u5173\u8054", width: 1000, visible: this.state.isModalVisible, footer: [
                    ...
                    react_1.default.createElement(antd_4.Tabs, { className: "Tabs_class", defaultActiveKey: "a", centered: true, onChange: Tabschange },
                        react_1.default.createElement(TabPane, { tab: "\u6750\u6599\u5408\u540C", key: "a" }),
                        react_1.default.createElement(TabPane, { tab: "\u52B3\u52A1\u5408\u540C", key: "b" }),
                        react_1.default.createElement(TabPane, { tab: "\u5206\u5305\u5408\u540C ", key: "c" }),
                        react_1.default.createElement(TabPane, { tab: "\u79DF\u8D41\u5408\u540C", key: "d" })),
