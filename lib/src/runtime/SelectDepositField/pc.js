...
var FormField = {
    ...
    onSearch: function (value) {
        ...
        var bizname = this.state.bizname;
        newvalue.name = value;
        newvalue.type = 0;
        newvalue.page = 1;
        this.setState({
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var SelectDepositField = form.getFieldInstance('SelectDeposit');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = SelectDepositField.getProp('id');
        ...
        spi
            .refreshData({
            modifiedBizAlias: ['SelectDeposit'],
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('SelectDeposit', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "SelectDepositField_class" },
            ' ',
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement(antd_4.Modal, { title: "\u9009\u62E9\u9879\u76EE", width: 1000, visible: this.state.isModalVisible, footer: [
                    ...
                    react_1.default.createElement(antd_4.Table, { scroll: { x: '60vw' }, onRow: function (record) {
                            return {
