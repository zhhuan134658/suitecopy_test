...
var FormField = {
    ...
    handleSave: function (row) {
        ...
        var timenum = this.state.timenum;
        console.log(row);
    ...
    timeChange: function (record, index, name, date, dateString) {
        ...
        if (record.plan_in_riqi && record.plan_out_riqi) {
            var timenum = this.getDaysBetween(record.plan_in_riqi, record.plan_out_riqi);
            if (timenum === 0) {
                antd_4.notification.open({
                    message: '请先选择正确的日期',
                });
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('TestLecon', 'placeholder');
        ...
        var deColumns = [
            ...
            },
            {
                ...
                width: 200,
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.plan_in_riqi },
                    react_1.default.createElement("span", null, record.plan_in_riqi))); },
            },
            {
                title: '计划退场日期',
                dataIndex: 'plan_out_riqi',
                width: 200,
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.plan_out_riqi },
                    react_1.default.createElement("span", null, record.plan_out_riqi))); },
            },
            {
                title: '数量',
                dataIndex: 'zl_number',
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.zl_number },
                    react_1.default.createElement("span", null, record.zl_number))); },
            },
            {
                title: '单价(元)',
                dataIndex: 'price',
        ...
        var etColumns = [
            ...
            },
            {
                ...
                render: function (text, record, index) {
                    return (react_1.default.createElement(antd_4.DatePicker, { format: "YYYY-MM-DD", placeholder: "\u8BF7\u9009\u62E9\u65E5\u671F", onChange: _this.timeChange.bind(_this, record, index, 'plan_in_riqi') }));
                },
            },
            {
                title: '计划退场日期',
                ...
                width: 200,
                render: function (text, record, index) {
                    return (react_1.default.createElement(antd_4.DatePicker, { format: "YYYY-MM-DD", placeholder: "\u8BF7\u9009\u62E9\u65E5\u671F", onChange: _this.timeChange.bind(_this, record, index, 'plan_out_riqi') }));
                },
            },
            {
                title: '数量',
        ...
        return (react_1.default.createElement("div", { className: "TestLeconField_class" },
