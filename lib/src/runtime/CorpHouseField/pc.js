...
var FormField = {
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var CorpHouseField = form.getFieldInstance('CorpHouse');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = CorpHouseField.getProp('id');
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('CorpHouse', 'placeholder');
        ...
        if (viewMode) {
            ...
            return (react_1.default.createElement("div", { className: "field-wrapper" },
                ...
                react_1.default.createElement("div", { style: { marginTop: '10px' } }, value)));
        }
        return (react_1.default.createElement("div", { className: "CorpHouse_class" },
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(antd_4.Input, { allowClear: true, 
                        // readOnly
                        value: this.state.Inputvalue, onClick: this.handleAdd, placeholder: "\u8BF7\u9009\u62E9\u5E93\u623F" })),
                react_1.default.createElement(antd_4.Modal, { title: "\u9009\u62E9\u5E93\u623F", width: 1000, visible: this.state.isModalVisible, footer: [
