...
//     form.setFieldValue('CorpSupplier', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('CorpSupplier');
//     const label = form.getFieldProp('CorpSupplier', 'label');
//     const placeholder = form.getFieldProp('CorpSupplier', 'placeholders');
//     return (
...
var FormField = {
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var CorpSupplierField = form.getFieldInstance('CorpSupplier');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = CorpSupplierField.getProp('id');
        // const value = CorpSupplierField.getValue();
        var value = '1';
        // const extendValue = CorpSupplierField.getExtendValue();
        var bizAsyncData = [
            {
                key: key,
        ...
        spi
            ...
            //   res.dataList,
            //   item => item.bizAlias === 'CorpSupplier',
            // );
    ...
    rowClick: function (record, rowkey) {
        ...
        this.setState({ Inputvalue: record.name, isModalVisible: false }, function () {
            ...
            form.setExtendFieldValue('CorpSupplier', {
                data: record.name,
            });
        });
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('CorpSupplier', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "CorpSupplier_class" },
            ' ',
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement(antd_4.Modal, { title: "\u9009\u62E9\u4F9B\u5E94\u5546", width: 1000, visible: this.state.isModalVisible, footer: [
                        ...
                        react_1.default.createElement(antd_4.Button, { type: "primary", loading: this.state.loading, onClick: this.handleOk }, "\u786E\u5B9A"),
