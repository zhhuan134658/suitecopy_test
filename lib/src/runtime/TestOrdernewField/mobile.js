...
var FormField = {
    ...
    habdlClick: function (item) {
        ...
        this.setState({ inputvalue: item.name, showElem: 'none', materialList: arr }, function () {
            form.setFieldValue('TestOrdernew', item.name);
    ...
    onInputchange: function (types, index, e) {
        ...
        switch (newtype) {
            case 'no_unit_price':
                if (arr[newindex].no_unit_price != '' &&
                    ...
                    //   含税单价
                    arr[newindex].unit_price = (arr[newindex].no_unit_price *
                        (1 + arr[newindex].tax_rate * 0.01)).toFixed(2);
                }
                else if (arr[newindex].no_unit_price == null &&
                    reg.test(arr[newindex].tax_rate) &&
                    arr[newindex].unit_price) {
                    arr[newindex].no_unit_price = (arr[newindex].unit_price /
                        (1 + arr[newindex].tax_rate * 0.01)).toFixed(2);
                }
                break;
            case 'unit_price':
                ...
                if (arr[newindex].unit_price &&
                    ...
                    reg.test(arr[newindex].tax_rate)) {
                    arr[newindex].no_amount_tax = ((arr[newindex].unit_price * arr[newindex].det_quantity) /
                        (1 + arr[newindex].tax_rate * 0.01)).toFixed(2);
                    arr[newindex].tax_amount = (((arr[newindex].unit_price * arr[newindex].det_quantity) /
            ...
            case 'tax_rate':
                ...
                if (arr[newindex].no_unit_price &&
                    arr[newindex].det_quantity &&
                    reg.test(arr[newindex].tax_rate)) {
                    arr[newindex].tax_amount = (arr[newindex].no_unit_price *
                        arr[newindex].det_quantity *
                        arr[newindex].tax_rate *
                        0.01).toFixed(2);
                    arr[newindex].amount_tax = (arr[newindex].no_unit_price *
                        arr[newindex].det_quantity *
                        (1 + arr[newindex].tax_rate * 0.01)).toFixed(2);
                }
                break;
        ...
        if (newtype != 'unit_price') {
            ...
            if (arr[newindex].no_unit_price && arr[newindex].det_quantity) {
                arr[newindex].no_amount_tax = (arr[newindex].no_unit_price * arr[newindex].det_quantity).toFixed(2);
            }
            //含税
            if (arr[newindex].no_unit_price &&
                arr[newindex].det_quantity &&
                                                    ...
                                                    react_1.default.createElement("div", { className: "m-field-wrapper" },
                                                        react_1.default.createElement("div", { className: "m-field m-field-mobile m-select-field" },
                                                            ...
                                                            react_1.default.createElement("div", { className: "m-field-box" },
                                                                react_1.default.createElement("div", { className: "m-field-content left" },
                                                                    react_1.default.createElement("div", { className: "input-wrapper" },
                                                                        react_1.default.createElement(antd_mobile_1.InputItem, { readOnly: true, clear: true, value: item.tax_amount, placeholder: "\u81EA\u52A8\u8BA1\u7B97", onChange: function (e) {
                                                                                return _this.onInputchange('tax_amount', index, e);
                                                                            } }))))))))),
                                        react_1.default.createElement("div", null,
                                            react_1.default.createElement("div", { className: "field-wrapper" },
                                                react_1.default.createElement("div", { className: "m-group m-group-mobile" },
                                                    react_1.default.createElement("div", { className: "m-field-wrapper" },
                                                        react_1.default.createElement("div", { className: "m-field m-field-mobile m-select-field" },
                                                            ...
                                                            react_1.default.createElement("div", { className: "m-field-box" },
                                                                react_1.default.createElement("div", { className: "m-field-content left" },
                                                                    react_1.default.createElement("div", { className: "input-wrapper" },
                                                                        react_1.default.createElement(antd_mobile_1.InputItem, { clear: true, readOnly: true, value: item.no_amount_tax, placeholder: "\u81EA\u52A8\u8BA1\u7B97", onChange: function (e) {
                                                                                return _this.onInputchange('no_amount_tax', index, e);
                                                                            } }))))))))),
                                        react_1.default.createElement("div", null,
                                            react_1.default.createElement("div", { className: "field-wrapper" },
                                                react_1.default.createElement("div", { className: "m-group m-group-mobile" },
                                                    react_1.default.createElement("div", { className: "m-field-wrapper" },
                                                        react_1.default.createElement("div", { className: "m-field m-field-mobile m-select-field" },
                                                            ...
                                                            react_1.default.createElement("div", { className: "m-field-box" },
                                                                react_1.default.createElement("div", { className: "m-field-content left" },
                                                                    react_1.default.createElement("div", { className: "input-wrapper" },
                                                                        react_1.default.createElement(antd_mobile_1.InputItem, { readOnly: true, clear: true, value: item.amount_tax, placeholder: "\u81EA\u52A8\u8BA1\u7B97", onChange: function (e) {
                                                                                return _this.onInputchange('amount_tax', index, e);
                                                                            } }))))))))))))));
                    }),
