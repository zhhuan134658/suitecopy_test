...
//     form.setFieldValue('SelectTbpro', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('SelectTbpro');
//     const label = form.getFieldProp('SelectTbpro', 'label');
//     const placeholder = form.getFieldProp('SelectTbpro', 'placeholders');
//     return (
...
var FormField = {
    getInitialState: function () {
        ...
        return {
            Inputvalue: form.getFieldInstance('SelectTbpro').getValue() || '',
            //   Inputvalue: '123',
            current_page: '',
            total2: '',
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var SelectTbproField = form.getFieldInstance('SelectTbpro');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = SelectTbproField.getProp('id');
        // const value = SelectTbproField.getValue();
        var value = '1';
        // const extendValue = SelectTbproField.getExtendValue();
        var bizAsyncData = [
            {
                key: key,
        ...
        spi
            ...
            //   res.dataList,
            //   item => item.bizAlias === 'SelectTbpro',
            // );
    ...
    rowClick: function (record, rowkey) {
        ...
        this.setState({ Inputvalue: record.name, isModalVisible: false }, function () {
            ...
            form.setExtendFieldValue('SelectTbpro', {
                id: record.id,
            });
        });
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('SelectTbpro', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "SelectTbproField_class" },
            ' ',
