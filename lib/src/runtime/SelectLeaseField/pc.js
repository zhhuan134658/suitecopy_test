...
var FormField = {
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var SelectLeaseField = form.getFieldInstance('SelectLease');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = SelectLeaseField.getProp('id');
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('SelectLease', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "SelectLeaseField_class" },
            ' ',
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement(antd_4.Modal, { title: "\u8BF7\u79DF\u8D41\u8BA1\u5212", width: 1000, visible: this.state.isModalVisible, footer: [
