...
//     form.setFieldValue('TestSubcon', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('TestSubcon');
//     const label = form.getFieldProp('TestSubcon', 'label');
//     const placeholder = form.getFieldProp('TestSubcon', 'placeholders');
//     return (
...
var FormField = {
    ...
    handleSave: function (row) {
        ...
        //   form.setFieldValue('TestSubcon', newData);
    ...
    fieldDidUpdate: function () {
        if (!this.props.runtimeProps.viewMode) {
            ...
            var form = this.props.form;
            form.setFieldValue('TestSubcon', detailname);
            form.setExtendFieldValue('TestSubcon', {
                data: detailname,
            });
        }
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('TestSubcon', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "TestSubconField_class" },
            ' ',
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement(antd_4.Modal, { title: "\u5173\u8054", width: 1000, visible: this.state.isModalVisible, footer: [
                    ...
                    react_1.default.createElement(antd_4.Tabs, { className: "Tabs_class", defaultActiveKey: "a", centered: true, onChange: Tabschange },
                        react_1.default.createElement(TabPane, { tab: "\u5206\u5305\u8FDB\u5EA6\u6B3E\u7ED3\u7B97", key: "a" }),
                        react_1.default.createElement(TabPane, { tab: "\u5206\u5305\u5B8C\u5DE5\u7ED3\u7B97", key: "b" }),
                        react_1.default.createElement(TabPane, { tab: "\u5206\u5305\u8D28\u4FDD\u91D1\u7ED3\u7B97 ", key: "c" }),
                        react_1.default.createElement(TabPane, { tab: "\u5206\u5305\u5408\u540C ", key: "d" })),
