...
//     const placeholder = form.getFieldProp('TestSet', 'placeholders');
//     return (
...
var FormField = {
    ...
    handleSave: function (row, values) {
        ...
        //   form.setFieldValue('TestSet', newData);
        //   form.setExtendFieldValue('TestSet', {
        //     data: newData,
        //   });
        // }
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var TestSetField = form.getFieldInstance('TestSet');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = TestSetField.getProp('id');
        // const value = TestSetField.getValue();
        var value = '1';
        // const extendValue = TestSetField.getExtendValue();
        var bizAsyncData = [
            {
                key: key,
                bizAlias: 'TestSet',
    ...
    fieldDidUpdate: function () {
        if (!this.props.runtimeProps.viewMode) {
            ...
            var form = this.props.form;
            form.setFieldValue('TestSet', editData);
            form.setExtendFieldValue('TestSet', {
                data: editData,
            });
        }
    ...
    fieldRender: function () {
        var _this = this;
        var form = this.props.form;
        var field = form.getFieldInstance('TestSet');
        var label = form.getFieldProp('TestSet', 'label');
        var placeholder = form.getFieldProp('TestSet', 'placeholder');
        var required = form.getFieldProp('TestSet', 'required');
        ...
        if (this.props.runtimeProps.viewMode) {
            ...
            return (react_1.default.createElement("div", { className: "field-wrapper" },
                ...
                react_1.default.createElement("div", { style: { marginTop: '10px' }, className: "label" }, "\u542B\u7A0E\u91D1\u989D(\u5143)"),
        ...
        return (react_1.default.createElement("div", { className: "TestSetField_class" },
            ' ',
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement("div", { style: { marginTop: '10px' } },
                    ...
                    react_1.default.createElement("div", { style: { marginTop: '10px' }, className: "label" }, "\u542B\u7A0E\u91D1\u989D\u5408\u8BA1(\u5143)"),
                    react_1.default.createElement("div", null,
                ...
                react_1.default.createElement(antd_4.Modal, { title: "\u5173\u8054", width: 1000, visible: this.state.isModalVisible, footer: [
                    ...
                    react_1.default.createElement(antd_4.Tabs, { className: "Tabs_class", defaultActiveKey: "a", centered: true, onChange: Tabschange },
                        ...
                        react_1.default.createElement(TabPane, { tab: "\u91C7\u8D2D\u8BA2\u5355", key: "b" },
                            ...
                            react_1.default.createElement(antd_1.Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })),
                        react_1.default.createElement(TabPane, { tab: "\u6750\u6599\u5165\u5E93", key: "c" },
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
