...
var FormField = {
    ...
    asyncSetFieldProps: function (vlauedata, typename) {
        ...
        var TestMaterialField = form.getFieldInstance('TestMaterial');
        var key = TestMaterialField.getProp('id');
        var value = '1';
        var bizAsyncData = [
            {
                key: key,
        ...
        if (this.props.runtimeProps.viewMode) {
            ...
            return (react_1.default.createElement("div", { className: "field-wrapper" },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement("div", { className: "field-wrapper" },
                        react_1.default.createElement("div", { className: "m-field-view" },
                            react_1.default.createElement("label", { className: "m-field-view-label" }, "\u4ED3\u5E93"),
                            react_1.default.createElement("div", { className: "m-field-view-value" },
                                react_1.default.createElement("span", null, warehouse)))))));
        }
        return (react_1.default.createElement("div", { className: "field-wrapper" },
                        ...
                        react_1.default.createElement("div", { className: "m-field-box" },
                            react_1.default.createElement("div", { className: "m-field-content left" },
                                react_1.default.createElement("div", { className: "input-wrapper" },
                                    react_1.default.createElement(antd_mobile_1.InputItem, { editable: false, value: this.state.Inputvalue, onClick: this.getcheckdata, placeholder: "\u8BF7\u9009\u62E9", readOnly: true }))))))),
            react_1.default.createElement("div", { className: "tablefield-mobile" },
                                                ...
                                                react_1.default.createElement("div", { className: "m-group m-group-mobile" },
                                                    react_1.default.createElement("div", { className: "m-field-wrapper" },
                                                        react_1.default.createElement("div", { className: "m-field m-field-mobile m-select-field" },
                                                            react_1.default.createElement("div", { className: "m-field-head" },
                                                                react_1.default.createElement("div", { className: "m-field-label" },
                                                                    react_1.default.createElement("span", null, "\u8D26\u5B58\u6570\u91CF"))),
                                                            react_1.default.createElement("div", { className: "m-field-box" },
                                                                react_1.default.createElement("div", { className: "m-field-content left" },
                                                                    react_1.default.createElement("div", { className: "input-wrapper" },
                                                                        react_1.default.createElement(antd_mobile_1.InputItem, { clear: true, value: item.wz_number, placeholder: "\u81EA\u52A8\u83B7\u53D6" }))))))))),
                                        react_1.default.createElement("div", null,
                                            react_1.default.createElement("div", { className: "field-wrapper" },
                                                react_1.default.createElement("div", { className: "m-group m-group-mobile" },
                                                    react_1.default.createElement("div", { className: "m-field-wrapper" },
                                                        react_1.default.createElement("div", { className: "m-field m-field-mobile m-select-field" },
                                                            react_1.default.createElement("div", { className: "m-field-head" },
                                                                react_1.default.createElement("div", { className: "m-field-label" },
                                                                    react_1.default.createElement("span", null, "\u76D8\u70B9\u6570\u91CF"))),
                                                            react_1.default.createElement("div", { className: "m-field-box" },
                                                                react_1.default.createElement("div", { className: "m-field-content left" },
                                                                    react_1.default.createElement("div", { className: "input-wrapper" },
                                                                        react_1.default.createElement(antd_mobile_1.InputItem, { clear: true, value: item.pd_number, placeholder: "\u8BF7\u8F93\u5165", onChange: function (e) {
                                                                                return _this.onInputchange('pd_number', index, e);
                                                                            } }))))))))))))));
                    }),
                    ' ',
            ...
            react_dom_1.createPortal(react_1.default.createElement(antd_mobile_1.Drawer, { className: "my-drawer", open: true, style: {
                    ...
                    textAlign: 'center',
                    paddingTop: 42,
                }, sidebar: checkdebar, onOpenChange: this.onOpenChange2 }), document.getElementById('MF_APP'))));
    },
};
