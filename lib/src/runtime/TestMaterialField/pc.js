...
//     form.setFieldValue('TestMaterial', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('TestMaterial');
//     const label = form.getFieldProp('TestMaterial', 'label');
//     const placeholder = form.getFieldProp('TestMaterial', 'placeholders');
//     return (
...
var FormField = {
    ...
    onSearchch: function (value) {
        ...
        this.asyncSetFielded(newvalue, 'CorpHouse');
        // this.asyncSetFieldch(newvalue);
    },
    onSearch: function (value) {
        ...
        this.asyncSetFielded(newvalue, 'TestMaterial');
    ...
    onChangepage: function (page) {
        ...
        this.asyncSetFielded(newpage, 'TestMaterial');
    ...
    handleAdd: function () {
        ...
        newdate.ck_name = '';
        newdate.isHouse = '2';
        this.asyncSetFielded(newdate, 'TestMaterial');
        // this.asyncSetFieldProps(newdate);
        this.setState({
            isModalVisible: true,
        });
    ...
    handleSave: function (row) {
        ...
        //   form.setFieldValue('TestMaterial', newData);
    ...
    //     },
    asyncSetFielded: function (vlauedata, typename) {
        var _this = this;
        var _a = this.props, form = _a.form, spi = _a.spi;
        var typenameField = form.getFieldInstance('TestMaterial');
        var key = typenameField.getProp('id');
        var value = '1';
        var bizAsyncData = [
            {
                key: key,
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('TestMaterial', 'placeholder');
        ...
        var deColumns = [
            ...
            },
            {
                title: '盘点数量',
                dataIndex: 'pd_number',
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.pd_number },
                    react_1.default.createElement("span", null, record.pd_number))); },
            },
        ];
        var etColumns = [
            {
        ...
        var onSelect = function (keys, info) {
            ...
            _this.asyncSetFielded(treedata, 'TestMaterial');
        ...
        var onFinish = function (values) {
            ...
            newdate.isHouse = '2';
            _this.asyncSetFielded(newdate, 'TestMaterial');
            //   this.asyncSetFieldProps(newdate);
            _this.setState({
                visibleModal: false,
            });
        ...
        if (this.props.runtimeProps.viewMode) {
            ...
            var _b = value.warehouse, warehouse = _b === void 0 ? '' : _b, _c = value.detailedData, detailedData = _c === void 0 ? [] : _c;
            return (react_1.default.createElement("div", { className: "field-wrapper" },
                react_1.default.createElement("div", { className: "label" }, "\u5E93\u623F"),
        ...
        return (react_1.default.createElement("div", { className: "TestMaterialField_class" },
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(antd_4.Input, { readOnly: true, value: this.state.Inputvalue, onClick: this.chhandleAdd, placeholder: "\u8BF7\u9009\u62E9" })),
                ...
                react_1.default.createElement("div", { style: { marginTop: 10 }, className: "label" }, "\u6750\u6599\u76D8\u70B9\u660E\u7EC6"),
                react_1.default.createElement("div", null,
