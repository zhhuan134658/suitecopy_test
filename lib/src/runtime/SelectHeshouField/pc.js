...
var mycolumnsa = [
    {
        ...
        render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.name },
            react_1.default.createElement("a", { onClick: function () { return handleDview(record); } }, record.name))); },
    },
    {
        title: '甲方',
        dataIndex: 'party_a',
...
var FormField = {
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var SelectHeshouField = form.getFieldInstance('SelectHeshou');
        var Pro_name = form.getFieldValue('Autopro');
        vlauedata.project_name = Pro_name;
        var key = SelectHeshouField.getProp('id');
        var value = '1';
        var bizAsyncData = [
            {
                key: key,
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('SelectHeshou', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "SelectHeshouField_class" },
            ' ',
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement(antd_4.Modal, { title: "\u5173\u8054", width: 1000, visible: this.state.isModalVisible, footer: [
                    ...
                    react_1.default.createElement(antd_4.Tabs, { className: "Tabs_class", defaultActiveKey: "a", centered: true, onChange: Tabschange },
                        react_1.default.createElement(TabPane, { tab: "\u6536\u5165\u5408\u540C", key: "a" },
                        ...
                        react_1.default.createElement(TabPane, { tab: "\u6536\u5165\u8FDB\u5EA6\u6B3E\u7ED3\u7B97", key: "b" },
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
                            ...
                            react_1.default.createElement(antd_1.Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })),
                        react_1.default.createElement(TabPane, { tab: "\u6536\u5165\u5B8C\u5DE5\u7ED3\u7B97 ", key: "c" },
                            ' ',
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
                            react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection), rowKey: function (record) { return record.id; }, columns: mycolumnsb, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
                            react_1.default.createElement(antd_1.Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })),
                        react_1.default.createElement(TabPane, { tab: "\u6536\u5165\u8D28\u4FDD\u91D1\u7ED3\u7B97", key: "d" },
                            ' ',
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
                            react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection), rowKey: function (record) { return record.id; }, columns: mycolumnsb, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
                            react_1.default.createElement(antd_1.Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })))))));
