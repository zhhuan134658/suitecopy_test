...
//     form.setFieldValue('TestLease', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('TestLease');
//     const label = form.getFieldProp('TestLease', 'label');
//     const placeholder = form.getFieldProp('TestLease', 'placeholders');
//     return (
...
var FormField = {
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var TestLeaseField = form.getFieldInstance('TestLease');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = TestLeaseField.getProp('id');
    ...
    fieldRender: function () {
        var _this = this;
        var form = this.props.form;
        var field = form.getFieldInstance('TestLease');
        var label = form.getFieldProp('TestLease', 'label');
        var placeholder = form.getFieldProp('TestLease', 'placeholder');
        var required = form.getFieldProp('TestLease', 'required');
        ...
        return (react_1.default.createElement("div", { className: "TestLeaseField_class" },
            ' ',
