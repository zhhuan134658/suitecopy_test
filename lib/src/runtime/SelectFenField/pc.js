...
//     form.setFieldValue('SelectFen', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('SelectFen');
//     const label = form.getFieldProp('SelectFen', 'label');
//     const placeholder = form.getFieldProp('SelectFen', 'placeholders');
//     return (
...
var FormField = {
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var SelectFenField = form.getFieldInstance('SelectFen');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = SelectFenField.getProp('id');
        // const value = SelectFenField.getValue();
        var value = '1';
        // const extendValue = SelectFenField.getExtendValue();
        var bizAsyncData = [
            {
                key: key,
                bizAlias: 'SelectFen',
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('SelectFen', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "SelectFenField_class" },
            ' ',
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(antd_4.Input, { readOnly: true, value: this.state.Inputvalue, onClick: this.handleAdd, placeholder: "\u8BF7\u9009\u62E9\u5408\u540C" })),
