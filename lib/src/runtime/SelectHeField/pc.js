...
//     const placeholder = form.getFieldProp('SelectHe', 'placeholders');
//     return (
...
var FormField = {
    ...
    handleChange: function (row) {
        ...
        // const { form } = this.props;
        // form.setFieldValue('SelectHe', e.target.value);
    ...
    handleAdd: function () {
        var form = this.props.form;
        var value = form.getFieldValue('Selectbaopro');
        if (value) {
            var newvalue = this.state.allData;
            newvalue.name = '';
            newvalue.type = 0;
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var proname = form.getFieldValue('SelectDeposit');
        ...
        var key = SelectHeField.getProp('id');
        // const value = SelectHeField.getValue();
        var value = '1';
        // const extendValue = SelectHeField.getExtendValue();
        var bizAsyncData = [
            {
                key: key,
                bizAlias: 'SelectHe',
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('SelectHe', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "SelectHeField_class" },
            ' ',
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(antd_4.Input, { allowClear: true, readOnly: true, value: this.state.Inputvalue, onClick: this.handleAdd, placeholder: "\u8BF7\u9009\u62E9\u5408\u540C" })),
                react_1.default.createElement(antd_4.Modal, { title: "\u9009\u62E9\u5408\u540C", width: 1000, visible: this.state.isModalVisible, footer: [
                    ...
                    react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165\u5408\u540C\u540D\u79F0", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
