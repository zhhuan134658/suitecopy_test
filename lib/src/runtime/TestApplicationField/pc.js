...
var FormField = {
    ...
    handleSave: function (row) {
        ...
        if (row.need_quantity && row.refer_price) {
            newData[index].subtotal = (row.need_quantity * row.refer_price).toFixed(2);
        }
        this.setState({
            dataSource: newData,
        });
    ...
    fieldDidUpdate: function () {
        if (!this.props.runtimeProps.viewMode) {
            ...
            console.log('uihsiuahfiausfaihiu', this.state.Inputmoney1, this.state.Inputmoney2);
            var editData = {
                hanmoney: '',
                nomoney: '',
                detailname: '',
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('TestApplication', 'placeholder');
        var required = form.getFieldProp('TestApplication', 'required');
        ...
        var deColumns = [
            ...
            },
            {
                ...
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.zh_plan_quantity },
                    react_1.default.createElement("span", null, record.zh_plan_quantity))); },
            },
            {
                title: '需用数量',
                dataIndex: 'need_quantity',
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.need_quantity },
                    react_1.default.createElement("span", null, record.need_quantity))); },
            },
            {
                title: '参考价格',
                dataIndex: 'refer_price',
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.refer_price },
                    react_1.default.createElement("span", null, record.refer_price))); },
            },
            {
                title: '小计(元)',
                dataIndex: 'subtotal',
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.subtotal },
                    react_1.default.createElement("span", null, record.subtotal))); },
            },
            {
                title: '备注',
                dataIndex: 'remarks',
        ...
        if (this.props.runtimeProps.viewMode) {
            ...
            var _b = value.detailname, detailname = _b === void 0 ? '' : _b, _c = value.detailedData, detailedData = _c === void 0 ? [] : _c, _d = value.hanmoney, hanmoney = _d === void 0 ? '' : _d;
            return (react_1.default.createElement("div", { className: "field-wrapper" },
                ...
                react_1.default.createElement("div", { className: "\u5408\u8BA1" },
                    " ",
                    label),
                react_1.default.createElement("div", { style: { marginTop: '10px' } }, hanmoney)));
        }
        return (react_1.default.createElement("div", { className: "TestApplicationField_class" },
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement("div", { style: { marginTop: '10px' } },
                    ...
                    react_1.default.createElement("div", { className: "label" }, "\u5408\u8BA1\u603B\u989D\uFF08\u5143\uFF09"),
                    react_1.default.createElement("div", null,
                ...
                react_1.default.createElement(antd_4.Modal, { title: "\u5173\u8054", width: 1000, visible: this.state.isModalVisible, footer: [
                    ...
                    react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection1), rowKey: function (record) { return record.id; }, columns: mycolumns, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
