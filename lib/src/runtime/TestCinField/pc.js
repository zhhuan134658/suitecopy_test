...
var FormField = {
    ...
    handleSave: function (row, values) {
        ...
        switch (Object.keys(values)[0]) {
            case 'no_unit_price':
                if (reg.test(row.no_unit_price) && reg.test(row.tax_rate)) {
                    ...
                    newData[index].unit_price = this.toFixed(this.accMul(row.no_unit_price, a), 2);
                }
                    ...
                    //   ).toFixed(2);
                    var a = 1 + row.tax_rate * 0.01;
                    newData[index].no_unit_price = this.toFixed(this.accDiv(row.unit_price, a), 2);
                }
                break;
            case 'unit_price':
                ...
                if (row.unit_price && row.det_quantity) {
                    ...
                    //   ).toFixed(2);
                    newData[index].amount_tax = this.toFixed(this.accMul(row.unit_price, row.det_quantity), 2);
                }
                //不含税金额
                if (row.unit_price && row.det_quantity && reg.test(row.tax_rate)) {
                    var a = 1 + row.tax_rate * 0.01;
                    var b = this.accMul(row.unit_price, row.det_quantity);
            ...
            case 'tax_rate':
                if (row.no_unit_price && !reg.test(row.unit_price)) {
                    ...
                    //   );
                    newData[index].unit_price = this.toFixed(row.no_unit_price * (1 + row.tax_rate * 0.01), 2);
                }
                    ...
                    //     2,
                    //   );
                    newData[index].no_unit_price = this.toFixed(row.unit_price / (1 + row.tax_rate * 0.01), 2);
                    newData[index].amount_tax = this.toFixed(row.unit_price * row.det_quantity, 2);
                    newData[index].no_amount_tax = this.toFixed((row.unit_price * row.det_quantity) / (1 + row.tax_rate * 0.01), 2);
                    newData[index].tax_amount = this.toFixed(newData[index].amount_tax - newData[index].no_amount_tax, 2);
                }
                ...
                if (reg.test(row.no_unit_price) &&
                    ...
                    reg.test(row.tax_rate)) {
                    var a = this.accMul(row.no_unit_price, row.det_quantity);
                    var b = this.accMul(row.tax_rate, 0.01);
                    ...
                    //     0.01
                    //   ).toFixed(2);
                    var c = this.accMul(row.no_unit_price, row.det_quantity);
                    var d = 1 + row.tax_rate * 0.01;
        ...
        if (Object.keys(values)[0] != 'unit_price') {
            ...
            if (row.no_unit_price && row.det_quantity) {
                newData[index].no_amount_tax = this.toFixed(this.accMul(row.no_unit_price, row.det_quantity), 2);
                // newData[index].no_amount_tax = (
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var TestCinField = form.getFieldInstance('TestCin');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = TestCinField.getProp('id');
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('TestCin', 'placeholder');
        ...
        //详情
        if (viewMode) {
            var value_1 = field.getValue();
            console.log('详情', value_1);
            var _c = value_1.detailname, detailname = _c === void 0 ? '' : _c, _d = value_1.nomoney, nomoney = _d === void 0 ? '' : _d, _e = value_1.hanmoney, hanmoney = _e === void 0 ? '' : _e, _f = value_1.detailedData, detailedData = _f === void 0 ? [] : _f;
            return (react_1.default.createElement("div", { className: "field-wrapper" },
                react_1.default.createElement("div", { className: "label" }, label),
                react_1.default.createElement("div", { style: { margin: '10px' } }, detailname),
                react_1.default.createElement("div", { className: "label" }, label),
                react_1.default.createElement("div", { style: { margin: '10px' } },
                    react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, components: components, rowClassName: function () { return 'editable-row'; }, bordered: true, dataSource: value_1 instanceof Array ? value_1 : detailedData, columns: deColumns, pagination: false })),
                react_1.default.createElement("div", { style: { margin: '10px' }, className: "label" }, "\u4E0D\u542B\u7A0E\u91D1\u989D\u5408\u8BA1(\u5143)"),
                react_1.default.createElement("div", { style: { margin: '10px' } }, nomoney),
                react_1.default.createElement("div", { style: { margin: '10px' }, className: "label" }, "\u542B\u7A0E\u91D1\u989D\u5408\u8BA1(\u5143)"),
                react_1.default.createElement("div", { style: { margin: '10px' } }, hanmoney)));
        }
        return (react_1.default.createElement("div", { className: "TestCinFieldong_class" },
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement(antd_4.Modal, { title: "\u5173\u8054", width: 1000, visible: this.state.isModalVisible, footer: [
                    ...
                    react_1.default.createElement(antd_4.Tabs, { className: "Tabs_class", defaultActiveKey: "a", centered: true, onChange: Tabschange },
                        react_1.default.createElement(TabPane, { tab: "\u6750\u6599\u603B\u8BA1\u5212", key: "c" },
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
                            react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection1), rowKey: function (record) { return record.id; }, columns: mycolumnsc, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
                        ...
                        react_1.default.createElement(TabPane, { tab: "\u91C7\u8D2D\u7533\u8BF7", key: "d" },
                            ' ',
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
                            react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection1), rowKey: function (record) { return record.id; }, columns: mycolumnsd, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
                            react_1.default.createElement(antd_1.Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })),
                        react_1.default.createElement(TabPane, { tab: "\u91C7\u8D2D\u5408\u540C", key: "a" },
                            ' ',
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
                            react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection1), rowKey: function (record) { return record.id; }, columns: mycolumnsa, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
                            react_1.default.createElement(antd_1.Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })),
                        react_1.default.createElement(TabPane, { tab: "\u91C7\u8D2D\u8BA2\u5355", key: "b" },
                            ' ',
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
                            react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection1), rowKey: function (record) { return record.id; }, columns: mycolumnsb, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
                            react_1.default.createElement(antd_1.Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })))),
                react_1.default.createElement(antd_4.Modal, { title: "\u9009\u62E9\u7269\u8D44", width: 1000, visible: this.state.isModalVisibletree, footer: [
                    ...
                    react_1.default.createElement(antd_3.Layout, null,
                        ...
                        react_1.default.createElement(Content, null,
                            ...
                            react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'checkbox' }, rowSelection), rowKey: function (record) { return record.id; }, columns: mycolumnstree, dataSource: this.state.treelistData, loading: this.state.loading, pagination: false }),
