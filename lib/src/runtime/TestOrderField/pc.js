...
//     const placeholder = form.getFieldProp('TestOrder', 'placeholders');
//     return (
...
var EditableCell = function (_a) {
    ...
    if (editable) {
        childNode = editing ? (react_1.default.createElement(antd_4.Form.Item, { style: { margin: 0 }, name: dataIndex },
            react_1.default.createElement(antd_4.InputNumber, { precision: 2, className: "editable-cell-value-inputNumber", ref: inputRef, onPressEnter: save, onBlur: save, min: 0, step: "0.01", placeholder: "\u8BF7\u8F93\u5165" }))) : (react_1.default.createElement("div", { className: "editable-cell-value-wrap", style: { paddingRight: 24 }, onClick: toggleEdit }, children));
        // childNode = (
        //   <Form.Item
        //     style={{ margin: 0 }}
        //     name={dataIndex}
...
var FormField = {
    ...
    handleSave: function (row, values) {
        ...
        //   form.setFieldValue('TestOrder', newData);
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var TestOrderField = form.getFieldInstance('TestOrder');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = TestOrderField.getProp('id');
        // const value = TestOrderField.getValue();
        var value = '1';
        // const extendValue = TestOrderField.getExtendValue();
        var bizAsyncData = [
            {
                key: key,
                bizAlias: 'TestOrder',
    ...
    fieldRender: function () {
        var _this = this;
        var form = this.props.form;
        var field = form.getFieldInstance('TestOrder');
        var label = form.getFieldProp('TestOrder', 'label');
        var placeholder = form.getFieldProp('TestOrder', 'placeholder');
        var required = form.getFieldProp('TestOrder', 'required');
        ...
        return (react_1.default.createElement("div", { className: "TestOrderField_class" },
