...
//     form.setFieldValue('SelectLao', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('SelectLao');
//     const label = form.getFieldProp('SelectLao', 'label');
//     const placeholder = form.getFieldProp('SelectLao', 'placeholders');
//     return (
...
var FormField = {
    getInitialState: function () {
        ...
        return {
            Inputvalue: form.getFieldInstance('SelectLao').getValue() || '',
            //   Inputvalue: '123',
            current_page: '',
            total2: '',
            allData: {
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var SelectLaoField = form.getFieldInstance('SelectLao');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = SelectLaoField.getProp('id');
        // const value = SelectLaoField.getValue();
        var value = '1';
        // const extendValue = SelectLaoField.getExtendValue();
        var bizAsyncData = [
            {
                key: key,
                bizAlias: 'SelectLao',
    ...
    rowClick: function (record, rowkey) {
        ...
        this.setState({ Inputvalue: record.name, isModalVisible: false }, function () {
            ...
            form.setExtendFieldValue('Selectjia', record.team);
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('SelectLao', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "SelectLaoField_class" },
            ' ',
