...
var FormField = {
    getInitialState: function () {
        ...
        return {
            Inputvalue: form.getFieldInstance('TestCollection').getValue() || '',
            //   Inputvalue: '123',
            current_page: '',
            total2: '',
            allData: {
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        // const value = TestCollectionField.getValue();
        var value = '1';
    ...
    fieldRender: function () {
        ...
        return (react_1.default.createElement("div", { className: "TestCollectionField_class" },
            ' ',
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement(antd_4.Modal, { title: "\u9009\u62E9\u5408\u540C", width: 1000, visible: this.state.isModalVisible, footer: [
                    ...
                    react_1.default.createElement(antd_4.Tabs, { className: "Tabs_class", defaultActiveKey: "1", centered: true },
                        ...
                        react_1.default.createElement(TabPane, { tab: "Tab 2", key: "2" },
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
                            react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, onRow: function (record) {
                                    return {
                                        onClick: _this.rowClick.bind(_this, record),
