...
//     form.setFieldValue('TestInspec', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('TestInspec');
//     const label = form.getFieldProp('TestInspec', 'label');
//     const placeholder = form.getFieldProp('TestInspec', 'placeholders');
//     return (
...
var FormField = {
    ...
    handleSave: function (row) {
        ...
        //   form.setFieldValue('TestInspec', newData);
        ...
        //   });
        // });
        console.log('sss', eval(newarr3.join('+')).toFixed(2).toFixed(2));
    },
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var TestInspecField = form.getFieldInstance('TestInspec');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = TestInspecField.getProp('id');
        // const value = TestInspecField.getValue();
        var value = '1';
        // const extendValue = TestInspecField.getExtendValue();
        var bizAsyncData = [
            {
                key: key,
                bizAlias: 'TestInspec',
    ...
    fieldRender: function () {
        var _this = this;
        var form = this.props.form;
        var field = form.getFieldInstance('TestInspec');
        var label = form.getFieldProp('TestInspec', 'label');
        var placeholder = form.getFieldProp('TestInspec', 'placeholder');
        var required = form.getFieldProp('SeleTestInspecctAcc', 'required');
        ...
        var deColumns = [
            ...
            },
            {
                ...
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.check_situation },
                    react_1.default.createElement("span", null, record.check_situation))); },
            },
            {
                title: '整改措施',
                dataIndex: 'rectify',
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.rectify },
                    react_1.default.createElement("span", null, record.rectify))); },
            },
        ];
        var etColumns = [
            {
        ...
        return (react_1.default.createElement("div", { className: "TestInspecField_class" },
