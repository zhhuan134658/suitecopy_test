...
//     form.setFieldValue('TestMater', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('TestMater');
//     const label = form.getFieldProp('TestMater', 'label');
//     const placeholder = form.getFieldProp('TestMater', 'placeholders');
//     return (
...
var FormField = {
    ...
    handleSave: function (row) {
        ...
        //   form.setFieldValue('TestMater', newData);
    ...
    fieldDidUpdate: function () {
        if (!this.props.runtimeProps.viewMode) {
            ...
            var form = this.props.form;
            form.setFieldValue('TestMater', detailname);
            form.setExtendFieldValue('TestMater', {
                data: detailname,
            });
        }
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('TestMater', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "TestMaterField_class" },
            ' ',
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement(antd_4.Modal, { title: "\u5173\u8054", width: 1000, visible: this.state.isModalVisible, footer: [
                    ...
                    react_1.default.createElement(antd_4.Tabs, { className: "Tabs_class", defaultActiveKey: "a", centered: true, onChange: Tabschange },
                        react_1.default.createElement(TabPane, { tab: "\u6750\u6599\u7ED3\u7B97", key: "a" },
                            ' ',
                        ...
                        react_1.default.createElement(TabPane, { tab: "\u91C7\u8D2D\u5408\u540C", key: "b" },
                            ' ',
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
                            ...
                            react_1.default.createElement(antd_1.Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })),
                        react_1.default.createElement(TabPane, { tab: "\u91C7\u8D2D\u8BA2\u5355 ", key: "c" },
                            ' ',
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
                            ...
                            react_1.default.createElement(antd_1.Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })),
                        react_1.default.createElement(TabPane, { tab: "\u6750\u6599\u5165\u5E93 ", key: "d" },
                            ' ',
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
                            react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection), rowKey: function (record) { return record.id; }, columns: mycolumnsd, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
                            react_1.default.createElement(antd_1.Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })))))));
    },
};
