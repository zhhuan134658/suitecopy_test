...
var mycolumnsa = [
    ...
    },
    {
        title: '租赁单位',
        dataIndex: 'supplier',
        render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.supplier },
            react_1.default.createElement("span", null, record.supplier))); },
    },
    {
        title: '结算金额（取结算中的批复金额）',
        dataIndex: 'reply_money',
        render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.reply_money },
            react_1.default.createElement("span", null, record.reply_money))); },
    },
];
var mycolumnsb = [
    {
    ...
    },
    {
        ...
        render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.contract_money },
            react_1.default.createElement("span", null, record.contract_money))); },
    },
];
var mycolumnsc = [
    {
    ...
    },
    {
        ...
        render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.extend_first },
            react_1.default.createElement("span", null, record.extend_first))); },
    },
    {
        title: '结算金额',
        dataIndex: 'detailed_money',
        render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.detailed_money },
            react_1.default.createElement("span", null, record.detailed_money))); },
    },
];
...
var FormField = {
    ...
    fieldRender: function () {
        ...
        return (react_1.default.createElement("div", { className: "TestRegistField_class" },
            react_1.default.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                react_1.default.createElement("div", null,
                    react_1.default.createElement(antd_4.Input, { readOnly: true, value: this.state.detailname, onClick: this.handleAdd, placeholder: "\u8BF7\u9009\u62E9" })),
                react_1.default.createElement(antd_4.Modal, { title: "\u9009\u62E9", width: 1000, visible: this.state.isModalVisible, footer: [
                    ...
                    react_1.default.createElement(antd_4.Tabs, { className: "Tabs_class", defaultActiveKey: "a", centered: true, onChange: Tabschange },
                        react_1.default.createElement(TabPane, { tab: "\u79DF\u8D41\u5408\u540C", key: "b" },
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
                            react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection), rowKey: function (record) { return record.id; }, columns: mycolumnsb, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
                        ...
                        react_1.default.createElement(TabPane, { tab: "\u79DF\u8D41\u7ED3\u7B97", key: "a" },
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
                            react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection), rowKey: function (record) { return record.id; }, columns: mycolumnsa, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
                            react_1.default.createElement(antd_1.Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })),
                        react_1.default.createElement(TabPane, { tab: "\u673A\u68B0\u8D39\u7ED3\u7B97", key: "c" },
                            react_1.default.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: this.onSearch }),
                            react_1.default.createElement(antd_4.Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection), rowKey: function (record) { return record.id; }, columns: mycolumnsc, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
                            react_1.default.createElement(antd_1.Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })))))));
    },
};
