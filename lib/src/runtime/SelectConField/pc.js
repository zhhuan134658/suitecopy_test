...
//     form.setFieldValue('SelectCon', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('SelectCon');
//     const label = form.getFieldProp('SelectCon', 'label');
//     const placeholder = form.getFieldProp('SelectCon', 'placeholders');
//     return (
...
var FormField = {
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        // const value = SelectConField.getValue();
        var value = '1';
        // const extendValue = SelectConField.getExtendValue();
        var bizAsyncData = [
            {
                key: key,
                bizAlias: 'SelectCon',
    ...
    fieldRender: function () {
        ...
        return (react_1.default.createElement("div", { className: "SelectConField_class" },
            ' ',
