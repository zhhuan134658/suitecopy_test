...
//     form.setFieldValue('SelectRelated', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('SelectRelated');
//     const label = form.getFieldProp('SelectRelated', 'label');
//     const placeholder = form.getFieldProp('SelectRelated', 'placeholders');
//     return (
...
var FormField = {
    ...
    handleAdd: function () {
        ...
        var value = form.getFieldValue('SelectHe');
            ...
            var mycolumns = [
                {
                    ...
                    render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.extend_five },
                        react_1.default.createElement("span", null, record.extend_five))); },
                },
                {
                    title: '收取单位',
                    dataIndex: 't1',
            ...
            var mycolumns = [
                {
                    ...
                    render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.extend_two },
                        react_1.default.createElement("span", null, record.extend_two))); },
                },
                {
                    title: '甲方单位',
                    dataIndex: 'party_a',
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var SelectRelatedField = form.getFieldInstance('SelectRelated');
        var proname = form.getFieldValue('Selectbaopro');
        var bontype = form.getFieldValue('RadioField');
        ...
        var key = SelectRelatedField.getProp('id');
        // const value = SelectRelatedField.getValue();
        var value = '1';
        // const extendValue = SelectRelatedField.getExtendValue();
        var bizAsyncData = [
            {
                key: key,
        ...
        spi
            .refreshData({
            modifiedBizAlias: ['SelectRelated'],
            ...
            //   res.dataList,
            //   item => item.bizAlias === 'SelectRelated',
            // );
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('SelectRelated', 'placeholder');
        ...
        return (react_1.default.createElement("div", { className: "SelectRelatedField_class" },
            ' ',
