...
//     form.setFieldValue('TestScience', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('TestScience');
//     const label = form.getFieldProp('TestScience', 'label');
//     const placeholder = form.getFieldProp('TestScience', 'placeholders');
//     return (
...
var FormField = {
    ...
    handleSave: function (row) {
        ...
        if (row.price) {
            newData[index].subtotal = row.price * row.wz_number;
        }
        this.setState({
            dataSource: newData,
        });
        ...
        //   form.setFieldValue('TestScience', newData);
        //   form.setExtendFieldValue('TestScience', {
        //     data: newData,
        //   });
        // }
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var TestScienceField = form.getFieldInstance('TestScience');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = TestScienceField.getProp('id');
        // const value = TestScienceField.getValue();
        var value = '1';
        // const extendValue = TestScienceField.getExtendValue();
        var bizAsyncData = [
            {
                key: key,
    ...
    fieldDidUpdate: function () {
        if (!this.props.runtimeProps.viewMode) {
            ...
            var form = this.props.form;
            form.setFieldValue('TestScience', editData);
            form.setExtendFieldValue('TestScience', {
                data: editData,
            });
        }
    ...
    fieldRender: function () {
        var _this = this;
        var form = this.props.form;
        var field = form.getFieldInstance('TestScience');
        var label = form.getFieldProp('TestScience', 'label');
        var placeholder = form.getFieldProp('TestScience', 'placeholder');
        var required = form.getFieldProp('TestScience', 'required');
        ...
        return (react_1.default.createElement("div", { className: "TestScienceField_class" },
            ' ',
