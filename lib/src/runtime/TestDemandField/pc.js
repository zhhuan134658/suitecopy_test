...
//     form.setFieldValue('TestDemand', e.target.value);
//   },
//   fieldRender() {
//     const { form } = this.props;
//     const field = form.getFieldInstance('TestDemand');
//     const label = form.getFieldProp('TestDemand', 'label');
//     const placeholder = form.getFieldProp('TestDemand', 'placeholders');
//     return (
...
var FormField = {
    ...
    handleSave: function (row) {
        ...
        //   form.setFieldValue('TestDemand', newData);
    ...
    asyncSetFieldProps: function (vlauedata) {
        ...
        var TestDemandField = form.getFieldInstance('TestDemand');
        // const leaveReasonField = form.getFieldInstance('leaveReason');
        var key = TestDemandField.getProp('id');
    ...
    rowClick: function (record, rowkey) {
        ...
        this.setState({ dataSource: newData, isModalVisible: false }, function () {
            form.setFieldValue('TestDemand', record);
            form.setExtendFieldValue('TestDemand', {
                record: record,
    ...
    fieldRender: function () {
        ...
        var placeholder = form.getFieldProp('TestDemand', 'placeholder');
        var required = form.getFieldProp('TestDemand', 'required');
        ...
        var deColumns = [
            ...
            },
            {
                ...
                render: function (_, record) { return (react_1.default.createElement(antd_4.Tooltip, { placement: "topLeft", title: record.need_number },
                    react_1.default.createElement("span", null, record.need_number))); },
            },
            {
                title: '备注',
                dataIndex: 'remarks',
        ...
        return (react_1.default.createElement("div", { className: "TestDemandField_class" },
            ' ',
