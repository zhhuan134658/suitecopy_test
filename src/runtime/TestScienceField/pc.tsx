...
const FormField: ISwapFormField = {
  ...
  asyncSetFieldProps(vlauedata) {
    ...
    const TestScienceField = form.getFieldInstance('TestScience');

    // const leaveReasonField = form.getFieldInstance('leaveReason');
    const key = TestScienceField.getProp('id');
    ...
    spi
      .refreshData({
        modifiedBizAlias: ['TestScience'], // spi接口要改动的是leaveReason的属性值
        bizAsyncData,
      })
      .then(res => {
        let newarr;
  ...
  fieldRender() {
    ...
    const field = form.getFieldInstance('TestScience');
    const label = form.getFieldProp('TestScience', 'label');
    const placeholder = form.getFieldProp('TestScience', 'placeholder');
    const required = form.getFieldProp('TestScience', 'required');
    ...
    return (
      <div className="TestScienceField_class">
        {' '}
        <div className="pc-custom-field-wrap">
          <div className="label">
            {required ? (
