...
const FormField: ISwapFormField = {
  ...
  fieldRender() {
    ...
    const field = form.getFieldInstance('TestMachinery');
    const label = form.getFieldProp('TestMachinery', 'label');
    const placeholder = form.getFieldProp('TestMachinery', 'placeholder');
    const required = form.getFieldProp('TestMachinery', 'required');
        ...
        render: (text, record, index) => {
          return (
            <DatePicker
              format="YYYY-MM-DD"
              placeholder="请选择日期"
              onChange={this.timeChange.bind(this, record, index, 'riqi')}
            />
          );
        },
      },
    ...
    return (
      <div className="TestMachineryField_class">
        {' '}
        <div className="pc-custom-field-wrap">
          <div className="label">
            {required ? (
