...
const FormField: ISwapFormField = {
  ...
  //     },
  asyncSetFielded(vlauedata, typename) {
    const { form, spi } = this.props;

    const typenameField = form.getFieldInstance('TestMaterial');

    const key = typenameField.getProp('id');
  ...
  fieldRender() {
    ...
    const field = form.getFieldInstance('TestMaterial');
    const label = form.getFieldProp('TestMaterial', 'label');
    const placeholder = form.getFieldProp('TestMaterial', 'placeholder');
    ...
    const onSelect = (keys: React.Key[], info: any) => {
      ...
      this.asyncSetFielded(treedata, 'TestMaterial');
