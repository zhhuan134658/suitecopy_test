...
const FormField: ISwapFormField = {
  ...
  asyncSetFieldProps(vlauedata) {
    ...
    const SelectFenField = form.getFieldInstance('SelectFen');

    // const leaveReasonField = form.getFieldInstance('leaveReason');
    const key = SelectFenField.getProp('id');
    ...
    spi
      .refreshData({
        modifiedBizAlias: ['SelectFen'], // spi接口要改动的是leaveReason的属性值
        bizAsyncData,
      })
      .then(res => {
  ...
  fieldRender() {
    ...
    return (
      <div className="SelectFenField_class">
        {' '}
        <div className="pc-custom-field-wrap">
          <div className="label">
            {required ? (
