...
const FormField: ISwapFormField = {
  ...
  asyncSetFieldProps(vlauedata) {
    ...
    const SelectZuField = form.getFieldInstance('SelectZu');

    // const leaveReasonField = form.getFieldInstance('leaveReason');
    const key = SelectZuField.getProp('id');
    ...
    spi
      .refreshData({
        modifiedBizAlias: ['SelectZu'], // spi接口要改动的是leaveReason的属性值
        bizAsyncData,
      })
      .then(res => {
  ...
  fieldRender() {
    ...
    const placeholder = form.getFieldProp('SelectZu', 'placeholder');
